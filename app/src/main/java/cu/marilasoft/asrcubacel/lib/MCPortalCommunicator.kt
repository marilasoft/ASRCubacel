...
interface MCPortalCommunicator {
    ...
    @Throws(CommunicationException::class, OperationException::class)
    fun signUp(phoneNumber: String, firstName: String, lastName: String, email: String): String {
        val mcPortal = MCPortal()
        mcPortal.signUp(phoneNumber, firstName, lastName, email)
    ...
    @Throws(CommunicationException::class, OperationException::class)
    fun completeSignUp(newPassword: String, cookies: MutableMap<String, String>)  {
        val mcPortal = MCPortal()
    ...
    fun loadMyAccount(loadHomePage: Boolean = false): ArrayList<NavigationPackage> {
        val mcPortal = MCPortal()
